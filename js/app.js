(() => {
    ...
    function showMore() {
        if (window.innerWidth <= 768) window.addEventListener("load", (function(e) {
            ...
            function getHeight(showMoreBlock, showMoreContent) {
                ...
                if ("items" === showMoreType) {
                    ...
                    const showMoreTypeValue = showMoreContent.dataset.showmoreContent ? showMoreContent.dataset.showmoreContent : 250;
    ...
    function initSliders() {
        ...
        if (document.querySelector(".advantage-brands__body")) new core(".advantage-brands__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    class MousePRLX {
        ...
        paralaxMouseInit(paralaxMouse) {
            paralaxMouse.forEach((el => {
                ...
                const paramAnimation = el.dataset.prlxA ? +el.dataset.prlxA : 1e3;
    ...
    function actions(e) {
        ...
        if (policy) {
            setTimeout((function() {
                policy.classList.add("_show");
            }), 3e3);
            document.querySelector(".policy__close").addEventListener("click", (function() {
                policy.classList.remove("_show");
            }));
            document.querySelector(".policy__button").addEventListener("click", (function() {
                policy.classList.remove("_show");
            }));
        }
    }
